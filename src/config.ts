...
export const Config: Schema<Config> = Schema.intersect([
    ...
    Schema.object({
        basic: Schema.object({
            ...
            smallGroupQuitMessage: Schema.string().default('该群人数过少（{memberCount}人），不满足最低人数要求（{threshold}人），机器人将自动退出。').description('小群自动退群时在群内发送的提示，支持变量{memberCount}, {threshold}, {groupName}, {groupId}'),
