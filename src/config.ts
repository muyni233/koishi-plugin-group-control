...
export const Config: Schema<Config> = Schema.intersect([
    ...
    Schema.object({
        invite: Schema.object({
            ...
            inviteApproveMessage: Schema.string().default('已自动通过您的群聊邀请，机器人正在加入群聊。').description('自动同意时发给邀请者的提示，支持变量 {groupName}, {groupId}, {userName}, {userId}'),
